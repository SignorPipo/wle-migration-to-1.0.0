...
import './pp/debug/debug_functions_overwriter/debug_functions_performance_analyzer/components/debug_pp_array_creation_performance_analyzer_component.js';
import './pp/debug/debug_functions_overwriter/debug_functions_performance_analyzer/components/debug_pp_functions_performance_analyzer_component.js';
...
import { GlobalGravityComponent } from './pp/gameplay/experimental/locomotion/components/global_gravity.js';
...
import './pp/plugin/mods/wle_mods/component_mods/clone_component_mod.js';
import './pp/plugin/mods/wle_mods/component_mods/cursor_component_mod.js';
import './pp/plugin/mods/wle_mods/component_mods/cursor_target_component_mod.js';
import './pp/plugin/mods/wle_mods/component_mods/mouse_look_component_mod.js';
import './pp/plugin/extensions/array_extension.js';
import './pp/plugin/extensions/math_extension.js';
import './pp/plugin/extensions/wle/object_extension.js';
import './pp/plugin/extensions/wle/scene_extension.js';
...
import { EasyLightAttenuationComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_light_attenuation.js';
import { EasyLightColorComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_light_color.js';
import { EasyMeshAmbientFactorComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_mesh_ambient_factor.js';
import { EasyMeshColorComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_mesh_color.js';
import './pp/tool/easy_tune/easy_object_tuners/easy_object_tuner.js';
import { EasyScaleComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_scale.js';
import { EasySetTuneTargetChildNumberComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_set_tune_target_child_number.js';
import { EasySetTuneTargeetGrabComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_set_tune_target_grab.js';
import { EasyTextColorComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_text_color.js';
import { EasyTransformComponent } from './pp/tool/easy_tune/easy_object_tuners/easy_transform.js';
...
import * as PP from "./pp/pp/init_pp"
PP.initPP(engine);
...
engine.registerComponent(EasyTuneComponent);
engine.registerComponent(EasyTuneImportVariablesComponent);
engine.registerComponent(EasyLightAttenuationComponent);
engine.registerComponent(EasyLightColorComponent);
engine.registerComponent(EasyMeshAmbientFactorComponent);
engine.registerComponent(EasyMeshColorComponent);
engine.registerComponent(EasyScaleComponent);
engine.registerComponent(EasySetTuneTargetChildNumberComponent);
engine.registerComponent(EasySetTuneTargeetGrabComponent);
engine.registerComponent(EasyTextColorComponent);
