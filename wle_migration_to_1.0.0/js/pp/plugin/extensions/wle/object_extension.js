/*
    ...
    In static functions (accessible directly through window.WL.Object) the suffix Objects means it will work on a given object list, example:
...
export function initObjectExtensionProtoype(engine) {
    if (window.WL != undefined && window.WL && window.WL.Object) {

        //GETTER

        //Position

        window.WL.Object.prototype.pp_getPosition = function pp_getPosition(position) {
            return this.pp_getPositionWorld(position);
        };

        window.WL.Object.prototype.pp_getPositionWorld = function pp_getPositionWorld(position = PP.vec3_create()) {
            this.getTranslationWorld(position);
            return position;
        };

        window.WL.Object.prototype.pp_getPositionLocal = function pp_getPositionLocal(position = PP.vec3_create()) {
        ...
        window.WL.Object.prototype.pp_getRotation = function pp_getRotation(rotation) {
            return this.pp_getRotationWorld(rotation);
        };
        window.WL.Object.prototype.pp_getRotationDegrees = function pp_getRotationDegrees(rotation) {
            return this.pp_getRotationWorldDegrees(rotation);
        };

        window.WL.Object.prototype.pp_getRotationRadians = function pp_getRotationRadians(rotation) {
            return this.pp_getRotationWorldRadians(rotation);
        };

        window.WL.Object.prototype.pp_getRotationMatrix = function pp_getRotationMatrix(rotation) {
            return this.pp_getRotationWorldMatrix(rotation);
        };

        window.WL.Object.prototype.pp_getRotationQuat = function pp_getRotationQuat(rotation) {
            return this.pp_getRotationWorldQuat(rotation);
        };

        //Rotation World

        window.WL.Object.prototype.pp_getRotationWorld = function pp_getRotationWorld(rotation) {
            return this.pp_getRotationWorldDegrees(rotation);
        };

        window.WL.Object.prototype.pp_getRotationWorldDegrees = function pp_getRotationWorldDegrees(rotation) {
        ...
        window.WL.Object.prototype.pp_getRotationWorldRadians = function () {
        ...
        window.WL.Object.prototype.pp_getRotationWorldMatrix = function () {
            let quat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_getRotationWorldQuat = function pp_getRotationWorldQuat(rotation = PP.quat_create()) {
        ...
        window.WL.Object.prototype.pp_getRotationLocal = function pp_getRotationLocal(rotation) {
            return this.pp_getRotationLocalDegrees(rotation);
        };

        window.WL.Object.prototype.pp_getRotationLocalDegrees = function pp_getRotationLocalDegrees(rotation) {
        ...
        window.WL.Object.prototype.pp_getRotationLocalRadians = function () {
            let quat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_getRotationLocalMatrix = function () {
            let quat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_getRotationLocalQuat = function pp_getRotationLocalQuat(rotation = PP.quat_create()) {
        ...
        window.WL.Object.prototype.pp_getScale = function pp_getScale(scale) {
            return this.pp_getScaleWorld(scale);
        };

        window.WL.Object.prototype.pp_getScaleWorld = function pp_getScaleWorld(scale = PP.vec3_create()) {
            scale.vec3_copy(this.scalingWorld);
            return scale;
        };

        window.WL.Object.prototype.pp_getScaleLocal = function pp_getScaleLocal(scale = PP.vec3_create()) {
        ...
        window.WL.Object.prototype.pp_getTransform = function pp_getTransform(transform) {
            return this.pp_getTransformWorld(transform);
        };

        window.WL.Object.prototype.pp_getTransformMatrix = function pp_getTransformMatrix(transform) {
            return this.pp_getTransformWorldMatrix(transform);
        };

        window.WL.Object.prototype.pp_getTransformQuat = function pp_getTransformQuat(transform) {
            return this.pp_getTransformWorldQuat(transform);
        };

        //Transform World

        window.WL.Object.prototype.pp_getTransformWorld = function pp_getTransformWorld(transform) {
            return this.pp_getTransformWorldMatrix(transform);
        };

        window.WL.Object.prototype.pp_getTransformWorldMatrix = function () {
        ...
        window.WL.Object.prototype.pp_getTransformWorldQuat = function pp_getTransformWorldQuat(transform = PP.quat2_create()) {
        ...
        window.WL.Object.prototype.pp_getTransformLocal = function (transform) {
            return this.pp_getTransformLocalMatrix(transform);
        };

        window.WL.Object.prototype.pp_getTransformLocalMatrix = function pp_getTransformLocalMatrix() {
            let transformQuat = PP.quat2_create();
            let scale = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_getTransformLocalQuat = function pp_getTransformLocalQuat(transform = PP.quat2_create()) {
        ...
        window.WL.Object.prototype.pp_getAxes = function pp_getAxes(axes) {
            return this.pp_getAxesWorld(axes);
        };

        window.WL.Object.prototype.pp_getAxesWorld = function pp_getAxesWorld(axes = [PP.vec3_create(), PP.vec3_create(), PP.vec3_create()]) {
        ...
        window.WL.Object.prototype.pp_getAxesLocal = function pp_getAxesLocal(axes = [PP.vec3_create(), PP.vec3_create(), PP.vec3_create()]) {
        ...
        window.WL.Object.prototype.pp_getForward = function pp_getForward(forward) {
            return this.pp_getForwardWorld(forward);
        };

        window.WL.Object.prototype.pp_getForwardWorld = function () {
        ...
        window.WL.Object.prototype.pp_getForwardLocal = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getBackward = function pp_getBackward(backward) {
            return this.pp_getBackwardWorld(backward);
        };

        window.WL.Object.prototype.pp_getBackwardWorld = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getBackwardLocal = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getUp = function pp_getUp(up) {
            return this.pp_getUpWorld(up);
        };

        window.WL.Object.prototype.pp_getUpWorld = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getUpLocal = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getDown = function pp_getDown(down) {
            return this.pp_getDownWorld(down);
        };

        window.WL.Object.prototype.pp_getDownWorld = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getDownLocal = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getLeft = function pp_getLeft(left) {
            return this.pp_getLeftWorld(left);
        };

        window.WL.Object.prototype.pp_getLeftWorld = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getLeftLocal = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getRight = function pp_getRight(right) {
            return this.pp_getRightWorld(right);
        };

        window.WL.Object.prototype.pp_getRightWorld = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_getRightLocal = function () {
            let rotation = PP.mat3_create();
        ...
        window.WL.Object.prototype.pp_setPosition = function pp_setPosition(position) {
            this.pp_setPositionWorld(position);
        };

        window.WL.Object.prototype.pp_setPositionWorld = function pp_setPositionWorld(position) {
            this.setTranslationWorld(position);
        };

        window.WL.Object.prototype.pp_setPositionLocal = function pp_setPositionLocal(position) {
            this.setTranslationLocal(position);
        };

        //Rotation

        window.WL.Object.prototype.pp_setRotation = function pp_setRotation(rotation) {
            this.pp_setRotationWorld(rotation);
        };
        window.WL.Object.prototype.pp_setRotationDegrees = function pp_setRotationDegrees(rotation) {
            this.pp_setRotationWorldDegrees(rotation);
        };

        window.WL.Object.prototype.pp_setRotationRadians = function pp_setRotationRadians(rotation) {
            this.pp_setRotationWorldRadians(rotation);
        };

        window.WL.Object.prototype.pp_setRotationMatrix = function pp_setRotationMatrix(rotation) {
            this.pp_setRotationWorldMatrix(rotation);
        };

        window.WL.Object.prototype.pp_setRotationQuat = function pp_setRotationQuat(rotation) {
            this.pp_setRotationWorldQuat(rotation);
        };

        //Rotation World

        window.WL.Object.prototype.pp_setRotationWorld = function pp_setRotationWorld(rotation) {
            this.pp_setRotationWorldDegrees(rotation);
        };

        window.WL.Object.prototype.pp_setRotationWorldDegrees = function () {
            let quat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_setRotationWorldRadians = function () {
        ...
        window.WL.Object.prototype.pp_setRotationWorldMatrix = function () {
            let quat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_setRotationWorldQuat = function pp_setRotationWorldQuat(rotation) {
            this.rotationWorld = rotation;
        };

        //Rotation Local

        window.WL.Object.prototype.pp_setRotationLocal = function pp_setRotationLocal(rotation) {
            this.pp_setRotationLocalDegrees(rotation);
        };

        window.WL.Object.prototype.pp_setRotationLocalDegrees = function () {
            let quat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_setRotationLocalRadians = function () {
            let degreesRotation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_setRotationLocalMatrix = function () {
            let quat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_setRotationLocalQuat = function pp_setRotationLocalQuat(rotation) {
            this.rotationLocal = rotation;
        };

        //Scale

        window.WL.Object.prototype.pp_setScale = function pp_setScale(scale) {
            this.pp_setScaleWorld(scale);
        };

        window.WL.Object.prototype.pp_setScaleWorld = function () {
        ...
        window.WL.Object.prototype.pp_setScaleLocal = function () {
            let vector = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_setAxes = function pp_setAxes(left, up, forward) {
            this.pp_setAxesWorld(left, up, forward);
        };

        window.WL.Object.prototype.pp_setAxesWorld = function pp_setAxesWorld(left, up, forward) {
            if (forward != null) {
        ...
        window.WL.Object.prototype.pp_setAxesLocal = function pp_setAxesLocal(left, up, forward) {
            if (forward != null) {
        ...
        window.WL.Object.prototype.pp_setForward = function pp_setForward(forward, up, left) {
            this.pp_setForwardWorld(forward, up, left);
        };

        window.WL.Object.prototype.pp_setForwardWorld = function pp_setForwardWorld(forward, up = null, left = null) {
            this._pp_setAxes([left, up, forward], [2, 1, 0], false);
        };

        window.WL.Object.prototype.pp_setForwardLocal = function pp_setForwardLocal(forward, up = null, left = null) {
            this._pp_setAxes([left, up, forward], [2, 1, 0], true);
        };

        //Backward

        window.WL.Object.prototype.pp_setBackward = function pp_setBackward(backward, up, left) {
            this.pp_setBackwardWorld(backward, up, left);
        };

        window.WL.Object.prototype.pp_setBackwardWorld = function () {
        ...
        window.WL.Object.prototype.pp_setBackwardLocal = function () {
            let forward = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_setUp = function pp_setUp(up, forward, left) {
            this.pp_setUpWorld(up, forward, left);
        };

        window.WL.Object.prototype.pp_setUpWorld = function pp_setUpWorld(up, forward = null, left = null) {
            this._pp_setAxes([left, up, forward], [1, 2, 0], false);
        };

        window.WL.Object.prototype.pp_setUpLocal = function pp_setUpLocal(up, forward = null, left = null) {
            this._pp_setAxes([left, up, forward], [1, 2, 0], true);
        };

        //Down

        window.WL.Object.prototype.pp_setDown = function pp_setDown(down, forward, left) {
            this.pp_setDownWorld(down, forward, left);
        };

        window.WL.Object.prototype.pp_setDownWorld = function () {
        ...
        window.WL.Object.prototype.pp_setDownLocal = function () {
            let up = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_setLeft = function pp_setLeft(left, up, forward) {
            this.pp_setLeftWorld(left, up, forward);
        };

        window.WL.Object.prototype.pp_setLeftWorld = function pp_setLeftWorld(left, up = null, forward = null) {
            this._pp_setAxes([left, up, forward], [0, 1, 2], false);
        };

        window.WL.Object.prototype.pp_setLeftLocal = function pp_setLeftLocal(left, up = null, forward = null) {
            this._pp_setAxes([left, up, forward], [0, 1, 2], true);
        };

        //Right

        window.WL.Object.prototype.pp_setRight = function pp_setRight(right, up, forward) {
            this.pp_setRightWorld(right, up, forward);
        };

        window.WL.Object.prototype.pp_setRightWorld = function () {
        ...
        window.WL.Object.prototype.pp_setRightLocal = function () {
            let left = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_setTransform = function pp_setTransform(transform) {
            this.pp_setTransformWorld(transform);
        };

        window.WL.Object.prototype.pp_setTransformMatrix = function pp_setTransformMatrix(transform) {
            this.pp_setTransformWorldMatrix(transform);
        };

        window.WL.Object.prototype.pp_setTransformQuat = function pp_setTransformQuat(transform) {
            this.pp_setTransformWorldQuat(transform);
        };

        //Transform World

        window.WL.Object.prototype.pp_setTransformWorld = function pp_setTransformWorld(transform) {
            return this.pp_setTransformWorldMatrix(transform);
        };

        window.WL.Object.prototype.pp_setTransformWorldMatrix = function () {
        ...
        window.WL.Object.prototype.pp_setTransformWorldQuat = function pp_setTransformWorldQuat(transform) {
            this.transformWorld = transform;
        };

        //Transform Local

        window.WL.Object.prototype.pp_setTransformLocal = function pp_setTransformLocal(transform) {
            return this.pp_setTransformLocalMatrix(transform);
        };

        window.WL.Object.prototype.pp_setTransformLocalMatrix = function () {
            let position = PP.vec3_create();
            let rotation = PP.quat_create();
            let scale = PP.vec3_create();
            let transformMatrixNoScale = PP.mat4_create();
        ...
        window.WL.Object.prototype.pp_setTransformLocalQuat = function pp_setTransformLocalQuat(transform) {
        ...
        window.WL.Object.prototype.pp_resetPosition = function pp_resetPosition() {
            this.pp_resetPositionWorld();
        };

        window.WL.Object.prototype.pp_resetPositionWorld = function () {
        ...
        window.WL.Object.prototype.pp_resetPositionLocal = function () {
            let zero = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_resetRotation = function pp_resetRotation() {
            this.pp_resetRotationWorld();
        };

        window.WL.Object.prototype.pp_resetRotationWorld = function () {
        ...
        window.WL.Object.prototype.pp_resetRotationLocal = function () {
            let identity = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_resetScale = function pp_resetScale() {
            this.pp_resetScaleWorld();
        };

        window.WL.Object.prototype.pp_resetScaleWorld = function () {
            let one = PP.vec3_create(1);
        ...
        window.WL.Object.prototype.pp_resetScaleLocal = function () {
            let one = PP.vec3_create(1);
        ...
        window.WL.Object.prototype.pp_resetTransform = function pp_resetTransform() {
            this.pp_resetTransformWorld();
        };

        window.WL.Object.prototype.pp_resetTransformWorld = function pp_resetTransformWorld() {
            this.pp_resetScaleWorld();
            this.pp_resetRotationWorld();
            this.pp_resetPositionWorld();
        };

        window.WL.Object.prototype.pp_resetTransformLocal = function pp_resetTransformLocal() {
        ...
        window.WL.Object.prototype.pp_translate = function pp_translate(translation) {
            this.pp_translateWorld(translation);
        };

        window.WL.Object.prototype.pp_translateWorld = function pp_translateWorld(translation) {
            this.translateWorld(translation);
        };

        window.WL.Object.prototype.pp_translateLocal = function pp_translateLocal(translation) {
            this.translate(translation);
        };

        window.WL.Object.prototype.pp_translateObject = function pp_translateObject(translation) {
            this.translateObject(translation);
        };

        //Translate Axis

        window.WL.Object.prototype.pp_translateAxis = function pp_translateAxis(amount, direction) {
            this.pp_translateAxisWorld(amount, direction);
        };

        window.WL.Object.prototype.pp_translateAxisWorld = function () {
        ...
        window.WL.Object.prototype.pp_translateAxisLocal = function () {
            let translation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_translateAxisObject = function () {
            let translation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotate = function pp_rotate(rotation) {
            this.pp_rotateWorld(rotation);
        };

        window.WL.Object.prototype.pp_rotateDegrees = function pp_rotateDegrees(rotation) {
            this.pp_rotateWorldDegrees(rotation);
        };

        window.WL.Object.prototype.pp_rotateRadians = function pp_rotateRadians(rotation) {
            this.pp_rotateWorldRadians(rotation);
        };

        window.WL.Object.prototype.pp_rotateMatrix = function pp_rotateMatrix(rotation) {
            this.pp_rotateWorldMatrix(rotation);
        };

        window.WL.Object.prototype.pp_rotateQuat = function pp_rotateQuat(rotation) {
            this.pp_rotateWorldQuat(rotation);
        };

        //Rotate World

        window.WL.Object.prototype.pp_rotateWorld = function pp_rotateWorld(rotation) {
            this.pp_rotateWorldDegrees(rotation);
        };

        window.WL.Object.prototype.pp_rotateWorldDegrees = function () {
        ...
        window.WL.Object.prototype.pp_rotateWorldRadians = function () {
            let degreesRotation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotateWorldMatrix = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateWorldQuat = function () {
        ...
        window.WL.Object.prototype.pp_rotateLocal = function pp_rotateLocal(rotation) {
            this.pp_rotateLocalDegrees(rotation);
        };

        window.WL.Object.prototype.pp_rotateLocalDegrees = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateLocalRadians = function () {
            let degreesRotation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotateLocalMatrix = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateLocalQuat = function () {
            let currentRotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateObject = function pp_rotateObject(rotation) {
            this.pp_rotateObjectDegrees(rotation);
        };

        window.WL.Object.prototype.pp_rotateObjectDegrees = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateObjectRadians = function () {
            let degreesRotation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotateObjectMatrix = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateObjectQuat = function pp_rotateObjectQuat(rotation) {
            this.rotateObject(rotation);
        };

        //Rotate Axis

        window.WL.Object.prototype.pp_rotateAxis = function pp_rotateAxis(angle, axis) {
            this.pp_rotateAxisWorld(angle, axis);
        };

        window.WL.Object.prototype.pp_rotateAxisDegrees = function pp_rotateAxisDegrees(angle, axis) {
            this.pp_rotateAxisWorldDegrees(angle, axis);
        };

        window.WL.Object.prototype.pp_rotateAxisRadians = function pp_rotateAxisRadians(angle, axis) {
            this.pp_rotateAxisWorldRadians(angle, axis);
        };

        //Rotate Axis World

        window.WL.Object.prototype.pp_rotateAxisWorld = function pp_rotateAxisWorld(angle, axis) {
            this.pp_rotateAxisWorldDegrees(angle, axis);
        };

        window.WL.Object.prototype.pp_rotateAxisWorldDegrees = function pp_rotateAxisWorldDegrees(angle, axis) {
            this.pp_rotateAxisWorldRadians(Math.pp_toRadians(angle), axis);
        };

        window.WL.Object.prototype.pp_rotateAxisWorldRadians = function () {
            let rotation = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAxisLocal = function pp_rotateAxisLocal(angle, axis) {
            this.pp_rotateAxisLocalDegrees(angle, axis);
        };

        window.WL.Object.prototype.pp_rotateAxisLocalDegrees = function pp_rotateAxisLocalDegrees(angle, axis) {
            this.pp_rotateAxisLocalRadians(Math.pp_toRadians(angle), axis);
        };

        window.WL.Object.prototype.pp_rotateAxisLocalRadians = function () {
            let rotation = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAxisObject = function pp_rotateAxisObject(angle, axis) {
            this.pp_rotateAxisObjectDegrees(angle, axis);
        };

        window.WL.Object.prototype.pp_rotateAxisObjectDegrees = function pp_rotateAxisObjectDegrees(angle, axis) {
            this.pp_rotateAxisObjectRadians(Math.pp_toRadians(angle), axis);
        };

        window.WL.Object.prototype.pp_rotateAxisObjectRadians = function () {
            let rotation = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAround = function pp_rotateAround(rotation, origin) {
            this.pp_rotateAroundWorld(rotation, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundDegrees = function pp_rotateAroundDegrees(rotation, origin) {
            this.pp_rotateAroundWorldDegrees(rotation, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundRadians = function pp_rotateAroundRadians(rotation, origin) {
            this.pp_rotateAroundWorldRadians(rotation, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundMatrix = function pp_rotateAroundMatrix(rotation, origin) {
            this.pp_rotateAroundWorldMatrix(rotation, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundQuat = function pp_rotateAroundQuat(rotation, origin) {
            this.pp_rotateAroundWorldQuat(rotation, origin);
        };

        //Rotate Around World

        window.WL.Object.prototype.pp_rotateAroundWorld = function pp_rotateAroundWorld(rotation, origin) {
            this.pp_rotateAroundWorldDegrees(rotation, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundWorldDegrees = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundWorldRadians = function () {
            let degreesRotation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundWorldMatrix = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundWorldQuat = function () {
        ...
        window.WL.Object.prototype.pp_rotateAroundLocal = function pp_rotateAroundLocal(rotation, origin) {
            this.pp_rotateAroundLocalDegrees(rotation, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundLocalDegrees = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundLocalRadians = function () {
            let degreesRotation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundLocalMatrix = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundLocalQuat = function () {
            let axis = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundObject = function pp_rotateAroundObject(rotation, origin) {
            this.pp_rotateAroundObjectDegrees(rotation, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundObjectDegrees = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundObjectRadians = function () {
            let degreesRotation = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundObjectMatrix = function () {
            let rotationQuat = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundObjectQuat = function () {
            let axis = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_rotateAroundAxis = function pp_rotateAroundAxis(angle, axis, origin) {
            this.pp_rotateAroundAxisWorld(angle, axis, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundAxisDegrees = function pp_rotateAroundAxisDegrees(angle, axis, origin) {
            this.pp_rotateAroundAxisWorldDegrees(angle, axis, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundAxisRadians = function pp_rotateAroundAxisRadians(angle, axis, origin) {
            this.pp_rotateAroundAxisWorldRadians(angle, axis, origin);
        };

        //Rotate Around Axis World

        window.WL.Object.prototype.pp_rotateAroundAxisWorld = function pp_rotateAroundAxisWorld(angle, axis, origin) {
            this.pp_rotateAroundAxisWorldDegrees(angle, axis, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundAxisWorldDegrees = function pp_rotateAroundAxisWorldDegrees(angle, axis, origin) {
            this.pp_rotateAroundAxisWorldRadians(Math.pp_toRadians(angle), axis, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundAxisWorldRadians = function () {
        ...
        window.WL.Object.prototype.pp_rotateAroundAxisLocal = function pp_rotateAroundAxisLocal(angle, axis, origin) {
            this.pp_rotateAroundAxisLocalDegrees(angle, axis, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundAxisLocalDegrees = function pp_rotateAroundAxisLocalDegrees(angle, axis, origin) {
            this.pp_rotateAroundAxisLocalRadians(Math.pp_toRadians(angle), axis, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundAxisLocalRadians = function () {
        ...
        window.WL.Object.prototype.pp_rotateAroundAxisObject = function pp_rotateAroundAxisObject(angle, axis, origin) {
            this.pp_rotateAroundAxisObjectDegrees(angle, axis, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundAxisObjectDegrees = function pp_rotateAroundAxisObjectDegrees(angle, axis, origin) {
            this.pp_rotateAroundAxisObjectRadians(Math.pp_toRadians(angle), axis, origin);
        };

        window.WL.Object.prototype.pp_rotateAroundAxisObjectRadians = function () {
            let convertedPosition = PP.vec3_create();
            let convertedAxis = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_scaleObject = function () {
            let vector = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_lookAt = function pp_lookAt(position, up) {
            this.pp_lookAtWorld(position, up);
        };

        window.WL.Object.prototype.pp_lookAtWorld = function () {
        ...
        window.WL.Object.prototype.pp_lookAtLocal = function () {
            let direction = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_lookTo = function pp_lookTo(direction, up) {
            this.pp_lookToWorld(direction, up);
        };

        window.WL.Object.prototype.pp_lookToWorld = function () {
        ...
        window.WL.Object.prototype.pp_lookToLocal = function () {
            let internalUp = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_setParent = function () {
            let position = PP.vec3_create();
            let rotation = PP.quat_create();
            let scale = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_getParent = function pp_getParent() {
            return this.parent;
        };

        //Convert Vector Object World

        window.WL.Object.prototype.pp_convertPositionObjectToWorld = function () {
        ...
        window.WL.Object.prototype.pp_convertDirectionObjectToWorld = function () {
            let rotation = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_convertPositionWorldToObject = function () {
            let matrix = PP.mat4_create();
        ...
        window.WL.Object.prototype.pp_convertDirectionWorldToObject = function () {
            let rotation = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_convertPositionLocalToWorld = function pp_convertPositionLocalToWorld(position, resultPosition = PP.vec3_create()) {
        ...
        window.WL.Object.prototype.pp_convertDirectionLocalToWorld = function pp_convertDirectionLocalToWorld(direction, resultDirection = PP.vec3_create()) {
            if (this.pp_getParent()) {
        ...
        window.WL.Object.prototype.pp_convertPositionWorldToLocal = function pp_convertPositionWorldToLocal(position, resultPosition = PP.vec3_create()) {
            if (this.pp_getParent()) {
        ...
        window.WL.Object.prototype.pp_convertDirectionWorldToLocal = function pp_convertDirectionWorldToLocal(direction, resultDirection = PP.vec3_create()) {
            if (this.pp_getParent()) {
        ...
        window.WL.Object.prototype.pp_convertPositionObjectToLocal = function pp_convertPositionObjectToLocal(position, resultPosition = PP.vec3_create()) {
        ...
        window.WL.Object.prototype.pp_convertDirectionObjectToLocal = function pp_convertDirectionObjectToLocal(direction, resultDirection = PP.vec3_create()) {
        ...
        window.WL.Object.prototype.pp_convertPositionLocalToObject = function pp_convertPositionLocalToObject(position, resultPosition = PP.vec3_create()) {
        ...
        window.WL.Object.prototype.pp_convertDirectionLocalToObject = function pp_convertDirectionLocalToObject(direction, resultDirection = PP.vec3_create()) {
        ...
        window.WL.Object.prototype.pp_convertTransformObjectToWorld = function pp_convertTransformObjectToWorld(transform, resultTransform) {
            return this.pp_convertTransformObjectToWorldMatrix(transform, resultTransform);
        };

        window.WL.Object.prototype.pp_convertTransformObjectToWorldMatrix = function () {
        ...
        window.WL.Object.prototype.pp_convertTransformObjectToWorldQuat = function () {
            let position = PP.vec3_create();
            let rotation = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_convertTransformWorldToObject = function pp_convertTransformWorldToObject(transform, resultTransform) {
            return this.pp_convertTransformWorldToObjectMatrix(transform, resultTransform);
        };

        window.WL.Object.prototype.pp_convertTransformWorldToObjectMatrix = function () {
            let convertTransform = PP.mat4_create();
            let position = PP.vec3_create();
            let scale = PP.vec3_create();
            let inverseScale = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_convertTransformWorldToObjectQuat = function () {
            let position = PP.vec3_create();
            let rotation = PP.quat_create();
        ...
        window.WL.Object.prototype.pp_convertTransformLocalToWorld = function pp_convertTransformLocalToWorld(transform, resultTransform) {
            return this.pp_convertTransformLocalToWorldMatrix(transform, resultTransform);
        };

        window.WL.Object.prototype.pp_convertTransformLocalToWorldMatrix = function pp_convertTransformLocalToWorldMatrix(transform, resultTransform = PP.mat4_create()) {
            if (this.pp_getParent()) {
        ...
        window.WL.Object.prototype.pp_convertTransformLocalToWorldQuat = function pp_convertTransformLocalToWorldQuat(transform, resultTransform = PP.quat2_create()) {
            if (this.pp_getParent()) {
        ...
        window.WL.Object.prototype.pp_convertTransformWorldToLocal = function pp_convertTransformWorldToLocal(transform, resultTransform) {
            return this.pp_convertTransformWorldToLocalMatrix(transform, resultTransform);
        };

        window.WL.Object.prototype.pp_convertTransformWorldToLocalMatrix = function pp_convertTransformWorldToLocalMatrix(transform, resultTransform = PP.mat4_create()) {
            if (this.pp_getParent()) {
        ...
        window.WL.Object.prototype.pp_convertTransformWorldToLocalQuat = function pp_convertTransformWorldToLocalQuat(transform, resultTransform = PP.quat2_create()) {
            if (this.pp_getParent()) {
        ...
        window.WL.Object.prototype.pp_convertTransformObjectToLocal = function pp_convertTransformObjectToLocal(transform, resultTransform) {
            return this.pp_convertTransformObjectToLocalMatrix(transform, resultTransform);
        };

        window.WL.Object.prototype.pp_convertTransformObjectToLocalMatrix = function pp_convertTransformObjectToLocalMatrix(transform, resultTransform = PP.mat4_create()) {
        ...
        window.WL.Object.prototype.pp_convertTransformObjectToLocalQuat = function pp_convertTransformObjectToLocalQuat(transform, resultTransform = PP.quat2_create()) {
        ...
        window.WL.Object.prototype.pp_convertTransformLocalToObject = function pp_convertTransformLocalToObject(transform, resultTransform) {
            return this.pp_convertTransformLocalToObjectMatrix(transform, resultTransform);
        };

        window.WL.Object.prototype.pp_convertTransformLocalToObjectMatrix = function pp_convertTransformLocalToObjectMatrix(transform, resultTransform = PP.mat4_create()) {
        ...
        window.WL.Object.prototype.pp_convertTransformLocalToObjectQuat = function pp_convertTransformLocalToObjectQuat(transform, resultTransform = PP.quat2_create()) {
        ...
        window.WL.Object.prototype.pp_addComponent = function pp_addComponent(type, paramsOrActive, active = null) {
            let params = null;
        ...
        window.WL.Object.prototype.pp_getComponent = function pp_getComponent(type, index = 0) {
            return this.pp_getComponentHierarchy(type, index);
        };

        window.WL.Object.prototype.pp_getComponentSelf = function pp_getComponentSelf(type, index = 0) {
            return this.getComponent(type, index);
        };

        window.WL.Object.prototype.pp_getComponentHierarchy = function pp_getComponentHierarchy(type, index = 0) {
            return this.pp_getComponentHierarchyBreadth(type, index);
        };

        window.WL.Object.prototype.pp_getComponentHierarchyBreadth = function pp_getComponentHierarchyBreadth(type, index = 0) {
            let objects = this.pp_getHierarchyBreadth();
            return window.WL.Object.pp_getComponentObjects(objects, type, index);
        };

        window.WL.Object.prototype.pp_getComponentHierarchyDepth = function pp_getComponentHierarchyDepth(type, index = 0) {
            let objects = this.pp_getHierarchyDepth();
            return window.WL.Object.pp_getComponentObjects(objects, type, index);
        };

        window.WL.Object.prototype.pp_getComponentDescendants = function pp_getComponentDescendants(type, index = 0) {
            return this.pp_getComponentDescendantsBreadth(type, index);
        };

        window.WL.Object.prototype.pp_getComponentDescendantsBreadth = function pp_getComponentDescendantsBreadth(type, index = 0) {
            let objects = this.pp_getDescendantsBreadth();
            return window.WL.Object.pp_getComponentObjects(objects, type, index);
        };

        window.WL.Object.prototype.pp_getComponentDescendantsDepth = function pp_getComponentDescendantsDepth(type, index = 0) {
            let objects = this.pp_getDescendantsDepth();
            return window.WL.Object.pp_getComponentObjects(objects, type, index);
        };

        window.WL.Object.prototype.pp_getComponentChildren = function pp_getComponentChildren(type, index = 0) {
            let objects = this.pp_getChildren();
            return window.WL.Object.pp_getComponentObjects(objects, type, index);
        };

        window.WL.Object.prototype.pp_getComponents = function pp_getComponents(type) {
            return this.pp_getComponentsHierarchy(type);
        };

        window.WL.Object.prototype.pp_getComponentsSelf = function pp_getComponentsSelf(type) {
            return this.getComponents(type);
        };

        window.WL.Object.prototype.pp_getComponentsHierarchy = function pp_getComponentsHierarchy(type) {
            return this.pp_getComponentsHierarchyBreadth(type);
        };

        window.WL.Object.prototype.pp_getComponentsHierarchyBreadth = function pp_getComponentsHierarchyBreadth(type) {
            let objects = this.pp_getHierarchyBreadth();
            return window.WL.Object.pp_getComponentsObjects(objects, type);
        };

        window.WL.Object.prototype.pp_getComponentsHierarchyDepth = function pp_getComponentsHierarchyDepth(type) {
            let objects = this.pp_getHierarchyDepth();
            return window.WL.Object.pp_getComponentsObjects(objects, type);
        };

        window.WL.Object.prototype.pp_getComponentsDescendants = function pp_getComponentsDescendants(type) {
            return this.pp_getComponentsDescendantsBreadth(type);
        };

        window.WL.Object.prototype.pp_getComponentsDescendantsBreadth = function pp_getComponentsDescendantsBreadth(type) {
            let objects = this.pp_getDescendantsBreadth();
            return window.WL.Object.pp_getComponentsObjects(objects, type);
        };

        window.WL.Object.prototype.pp_getComponentsDescendantsDepth = function pp_getComponentsDescendantsDepth(type) {
            let objects = this.pp_getDescendantsDepth();
            return window.WL.Object.pp_getComponentsObjects(objects, type);
        };

        window.WL.Object.prototype.pp_getComponentsChildren = function pp_getComponentsChildren(type) {
            let objects = this.pp_getChildren();
            return window.WL.Object.pp_getComponentsObjects(objects, type);
        };
        ...
        window.WL.Object.prototype.pp_setActive = function pp_setActive(active, applyToHierarchy = true) {
            if (applyToHierarchy) {
        ...
        window.WL.Object.prototype.pp_setActiveSelf = function pp_setActiveSelf(active) {
            this.pp_setActive(active, false);
        };

        window.WL.Object.prototype.pp_setActiveHierarchy = function pp_setActiveHierarchy(active) {
            this.pp_setActiveHierarchyBreadth(active);
        };

        window.WL.Object.prototype.pp_setActiveHierarchyBreadth = function pp_setActiveHierarchyBreadth(active) {
            let objects = this.pp_getHierarchyBreadth();
            return window.WL.Object.pp_setActiveObjects(objects, active);
        };

        window.WL.Object.prototype.pp_setActiveHierarchyDepth = function pp_setActiveHierarchyDepth(active) {
            let objects = this.pp_getHierarchyDepth();
            return window.WL.Object.pp_setActiveObjects(objects, active);
        };

        window.WL.Object.prototype.pp_setActiveDescendants = function pp_setActiveDescendants(active) {
            this.pp_setActiveDescendantsBreadth(active);
        };

        window.WL.Object.prototype.pp_setActiveDescendantsBreadth = function pp_setActiveDescendantsBreadth(active) {
            let objects = this.pp_getDescendantsBreadth();
            return window.WL.Object.pp_setActiveObjects(objects, active);
        };

        window.WL.Object.prototype.pp_setActiveDescendantsDepth = function pp_setActiveDescendantsDepth(active) {
            let objects = this.pp_getDescendantsDepth();
            return window.WL.Object.pp_setActiveObjects(objects, active);
        };

        window.WL.Object.prototype.pp_setActiveChildren = function pp_setActiveChildren(active) {
            let objects = this.pp_getChildren();
            return window.WL.Object.pp_setActiveObjects(objects, active);
        };
        ...
        window.WL.Object.prototype.pp_hasUniformScale = function pp_hasUniformScale() {
            return this.pp_hasUniformScaleWorld();
        };

        window.WL.Object.prototype.pp_hasUniformScaleWorld = function () {
            let scale = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_hasUniformScaleLocal = function () {
            let scale = PP.vec3_create();
        ...
        window.WL.Object.prototype.pp_clone = function () {
            let scale = PP.vec3_create();
            let transformQuat = PP.quat2_create();
            return function pp_clone(params = new PP.CloneParams()) {
                ...
                if (this.pp_isCloneable(params)) {
                    ...
                    while (objectsToCloneData.length > 0) {
                        ...
                        let currentClonedObject = window.WL.scene.addObject(parent);
        ...
        window.WL.Object.prototype.pp_isCloneable = function pp_isCloneable(params = new PP.CloneParams()) {
        ...
        window.WL.Object.prototype.pp_toString = function pp_toString() {
            return this.pp_toStringCompact();
        }

        window.WL.Object.prototype.pp_toStringExtended = function () {
            let tab = "    ";
            let newLine = "\n";
            let startObject = "{";
            let endObject = "}";
        ...
        window.WL.Object.prototype.pp_toStringCompact = function () {
            let tab = "    ";
            let newLine = "\n";
            let emptyName = "<none>";
            let nameLabel = "name: ";
        ...
        window.WL.Object.prototype.pp_getObjectByName = function pp_getObjectByName(name) {
            return this.pp_getObjectByNameHierarchy(name);
        }

        window.WL.Object.prototype.pp_getObjectByNameHierarchy = function pp_getObjectByNameHierarchy(name) {
            return this.pp_getObjectByNameHierarchyBreadth(name);
        }

        window.WL.Object.prototype.pp_getObjectByNameHierarchyBreadth = function pp_getObjectByNameHierarchyBreadth(name) {
            let objects = this.pp_getHierarchyBreadth();
            return window.WL.Object.pp_getObjectByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectByNameHierarchyDepth = function pp_getObjectByNameHierarchyDepth(name) {
            let objects = this.pp_getHierarchyDepth();
            return window.WL.Object.pp_getObjectByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectByNameDescendants = function pp_getObjectByNameDescendants(name) {
            return this.pp_getObjectByNameDescendantsBreadth(name);
        }

        window.WL.Object.prototype.pp_getObjectByNameDescendantsBreadth = function pp_getObjectByNameDescendantsBreadth(name) {
            let objects = this.pp_getDescendantsBreadth();
            return window.WL.Object.pp_getObjectByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectByNameDescendantsDepth = function pp_getObjectByNameDescendantsDepth(name) {
            let objects = this.pp_getDescendantsDepth();
            return window.WL.Object.pp_getObjectByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectByNameChildren = function pp_getObjectByNameChildren(name) {
            let objects = this.pp_getChildren();
            return window.WL.Object.pp_getObjectByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectsByName = function pp_getObjectsByName(name) {
            return this.pp_getObjectsByNameHierarchy(name);
        }

        window.WL.Object.prototype.pp_getObjectsByNameHierarchy = function pp_getObjectsByNameHierarchy(name) {
            return this.pp_getObjectsByNameHierarchyBreadth(name);
        }

        window.WL.Object.prototype.pp_getObjectsByNameHierarchyBreadth = function pp_getObjectsByNameHierarchyBreadth(name) {
            let objects = this.pp_getHierarchyBreadth();
            return window.WL.Object.pp_getObjectsByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectsByNameHierarchyDepth = function pp_getObjectsByNameHierarchyDepth(name) {
            let objects = this.pp_getHierarchyDepth();
            return window.WL.Object.pp_getObjectsByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectsByNameDescendants = function pp_getObjectsByNameDescendants(name) {
            return this.pp_getObjectsByNameDescendantsBreadth(name);
        }

        window.WL.Object.prototype.pp_getObjectsByNameDescendantsBreadth = function pp_getObjectsByNameDescendantsBreadth(name) {
            let objects = this.pp_getDescendantsBreadth();
            return window.WL.Object.pp_getObjectsByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectsByNameDescendantsDepth = function pp_getObjectsByNameDescendantsDepth(name) {
            let objects = this.pp_getDescendantsDepth();
            return window.WL.Object.pp_getObjectsByNameObjects(objects, name);
        }

        window.WL.Object.prototype.pp_getObjectsByNameChildren = function pp_getObjectsByNameChildren(name) {
            let objects = this.pp_getChildren();
            return window.WL.Object.pp_getObjectsByNameObjects(objects, name);
        }
        ...
        window.WL.Object.prototype.pp_getHierarchy = function pp_getHierarchy() {
            return this.pp_getHierarchyBreadth();
        };

        window.WL.Object.prototype.pp_getHierarchyBreadth = function pp_getHierarchyBreadth() {
        ...
        window.WL.Object.prototype.pp_getHierarchyDepth = function pp_getHierarchyDepth() {
        ...
        window.WL.Object.prototype.pp_getDescendants = function pp_getDescendants() {
            return this.pp_getDescendantsBreadth();
        };

        window.WL.Object.prototype.pp_getDescendantsBreadth = function pp_getDescendantsBreadth() {
            let descendants = [];
        ...
        window.WL.Object.prototype.pp_getDescendantsDepth = function pp_getDescendantsDepth() {
            let descendants = [];
        ...
        window.WL.Object.prototype.pp_getChildren = function pp_getChildren() {
            return this.children;
        };

        window.WL.Object.prototype.pp_getSelf = function pp_getSelf() {
            return this;
        };

        //Cauldron

        window.WL.Object.prototype.pp_addObject = function pp_addObject() {
            return window.WL.scene.addObject(this);
        };

        window.WL.Object.prototype.pp_getName = function pp_getName() {
            return this.name;
        };

        window.WL.Object.prototype.pp_setName = function pp_setName(name) {
            this.name = name;
        };

        window.WL.Object.prototype.pp_getID = function pp_getID() {
            return this.objectId;
        };

        window.WL.Object.prototype.pp_markDirty = function pp_markDirty() {
            return this.setDirty();
        };

        window.WL.Object.prototype.pp_equals = function pp_equals(otherObject) {
            return this.equals(otherObject);
        };

        window.WL.Object.prototype.pp_destroy = function pp_destroy() {
            return this.destroy();
        };

        window.WL.Object.prototype.pp_reserveObjects = function pp_reserveObjects(count) {
            this.pp_reserveObjectsHierarchy(count);
        };

        window.WL.Object.prototype.pp_reserveObjectsSelf = function pp_reserveObjectsSelf(count) {
            let componentsAmountMap = this.pp_getComponentsAmountMapSelf();
            this._pp_reserveObjects(count, componentsAmountMap);
        };

        window.WL.Object.prototype.pp_reserveObjectsHierarchy = function pp_reserveObjectsHierarchy(count) {
            let componentsAmountMap = this.pp_getComponentsAmountMapHierarchy();
            this._pp_reserveObjects(count, componentsAmountMap);
        };

        window.WL.Object.prototype.pp_reserveObjectsDescendants = function pp_reserveObjectsDescendants(count) {
            let componentsAmountMap = this.pp_getComponentsAmountMapDescendants();
            this._pp_reserveObjects(count, componentsAmountMap);
        };

        window.WL.Object.prototype.pp_reserveObjectsChildren = function pp_reserveObjectsChildren(count) {
            let componentsAmountMap = this.pp_getComponentsAmountMapChildren();
            this._pp_reserveObjects(count, componentsAmountMap);
        };

        window.WL.Object.prototype.pp_getComponentsAmountMap = function pp_getComponentsAmountMap(amountMap = new Map()) {
            return this.pp_getComponentsAmountMapHierarchy(amountMap);
        };

        window.WL.Object.prototype.pp_getComponentsAmountMapSelf = function pp_getComponentsAmountMapSelf(amountMap = new Map()) {
        ...
        window.WL.Object.prototype.pp_getComponentsAmountMapHierarchy = function pp_getComponentsAmountMapHierarchy(amountMap = new Map()) {
        ...
        window.WL.Object.prototype.pp_getComponentsAmountMapDescendants = function pp_getComponentsAmountMapDescendants(amountMap = new Map()) {
        ...
        window.WL.Object.prototype.pp_getComponentsAmountMapChildren = function pp_getComponentsAmountMapChildren(amountMap = new Map()) {
            let children = this.pp_getChildren();
        ...
        window.WL.Object.prototype._pp_epsilon = 0.000001;

        window.WL.Object.prototype._pp_quaternionToRadians = function () {
        ...
        window.WL.Object.prototype._pp_degreesToQuaternion = function _pp_degreesToQuaternion(degreesRotation, quatRotation = PP.quat_create()) {
            quatRotation.quat_fromDegrees(degreesRotation);
            return quatRotation;
        };

        window.WL.Object.prototype._pp_toDegrees = function _pp_toDegrees(angle) {
            return angle * (180 / Math.PI);
        };

        window.WL.Object.prototype._pp_clamp = function _pp_clamp(value, min, max) {
            return Math.min(Math.max(value, min), max);
        };

        window.WL.Object.prototype._pp_reserveObjects = function _pp_reserveObjects(count, componentsAmountMap) {
            ...
            window.WL.scene.reserveObjects(objectsToReserve, componentsToReserve);
        };

        window.WL.Object.prototype._pp_setAxes = function () {
        ...
        for (let key in window.WL.Object.prototype) {
            ...
            if (found) {
                Object.defineProperty(window.WL.Object.prototype, key, { enumerable: false });
            }
        }
...
export function initObjectExtensionStatic(engine) {

    window.WL.Object.pp_getComponentObjects = function pp_getComponentObjects(objects, type, index = 0) {
        let component = null;
    ...
    window.WL.Object.pp_getComponentsObjects = function pp_getComponentsObjects(objects, type) {
        let components = [];
    ...
    window.WL.Object.pp_setActiveObjects = function pp_setActiveObjects(objects, active) {
        for (let object of objects) {
            object.active = active;
        }
    };

    window.WL.Object.pp_getObjectByNameObjects = function pp_getObjectByNameObjects(objects, name) {
    ...
    window.WL.Object.pp_getObjectsByNameObjects = function pp_getObjectsByNameObjects(objects, name) {
        let objectsFound = [];
    ...
    for (let key in window.WL.Object) {
        let prefixes = ["pp_", "_pp_"];
        ...
        if (found) {
            Object.defineProperty(window.WL.Object, key, { enumerable: false });
        }
    }
}