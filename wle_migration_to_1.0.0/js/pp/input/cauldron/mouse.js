...
export class Mouse {
    ...
    getOriginWorld(out = vec3_create()) {
        if (XRUtils.isSessionActive(this._myEngine)) {
            ...
            getPlayerObjects(this._myEngine).myNonVRCamera.pp_getPosition(out);
        }
    ...
    getDirectionWorld(out = vec3_create()) {
        ...
        if (XRUtils.isSessionActive(this._myEngine)) {
            ...
            projectionMatrixInvert = getPlayerObjects(this._myEngine).myNonVRCamera.pp_getComponent(ViewComponent).projectionMatrix.mat4_invert(projectionMatrixInvert);
        }
        ...
        if (XRUtils.isSessionActive(this._myEngine)) {
            ...
            directionWorld = directionLocal.vec3_transformQuat(getPlayerObjects(this._myEngine).myNonVRCamera.pp_getRotationQuat(this._myRotationQuat), directionLocal);
        }
